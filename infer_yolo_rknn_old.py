...
def draw_filled_box_with_border(img, x1, y1, x2, y2, fill_color, border_color, border_thickness=2):
    """
    绘制带边框的填充矩形框
    """
    # 绘制填充矩形
...
def main():
    ...
    if detections:
        ...
        for det in detections:
            ...
            # 绘制绿色填充框
            draw_filled_box_with_border(img, x1, y1, x2, y2, 
            ...
            # 绘制标签背景
            cv2.rectangle(img, (x1, y1 - text_height - 10), (x1 + text_width, y1), (0, 200, 0), -1)
        ...
        if overall_bbox:
            ...
            # 绘制红色填充框
            draw_filled_box_with_border(img, x1, y1, x2, y2,
                                       fill_color=(0, 0, 255),  # 红色填充
                                       border_color=(0, 0, 200),  # 深红色边框
                                       border_thickness=3)
            ...
            # 绘制标签背景
            label_y = max(20, y1 - text_height - 10)
            cv2.rectangle(img, (x1, label_y), (x1 + text_width, y1), (0, 0, 200), -1)
